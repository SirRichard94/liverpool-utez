...
public class EmpleadoAction extends ActionSupport {
    ...
    public String registrarEmpleado() throws SQLException {
        UsuarioBean user = new UsuarioBean(nombre, apellidoP, apellidoM, fechaN, direccion, cuentaB, nombreU, password, email, "Empleado");
    ...
    public String consultarEmpleados() throws SQLException {
        UsuarioDao daoU = new UsuarioDao();
        lista = daoU.consultarEmpleados();
        return SUCCESS;
    }

    public String consultarEmpleadoIndividual() throws SQLException, ParseException {
        UsuarioDao daoU = new UsuarioDao();
    ...
    public String eliminarEmpleado() throws SQLException {
        UsuarioDao daoU = new UsuarioDao();

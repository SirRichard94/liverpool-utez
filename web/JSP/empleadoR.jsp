...
<html lang="es">
    <head>
        <title>Liverpool - Empleados</title>
    ...
    <div class="container">
        ...
        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
        <br/>
        <s:form name="link" action="empleadoCreate" method="post">
            <s:submit value="Registrar empleado" cssClass="btn btn-primary pull-right"/>
        </s:form>
        </div>
        <div class="col-md-12">
            <br>
        ...
        <table id="tabla1" class="table table-striped table-bordered" style="background: lightpink">
            ...
            <tbody>
                <s:iterator id="usuarios" value="lista">
                    <s:url id="actualizarUsuario" action="empleadoU1.action">
                        <s:param name="idUsuario" value="idUsuario"/>
                    </s:url>                
                    <s:url id="eliminarUsuario" action="empleadoD.action">
                        <s:param name="idUsuario" value="idUsuario"/>
                    </s:url>
                    <tr>
